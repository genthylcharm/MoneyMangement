...
import com.dvl.moneymanagement.Adapters.LoanAdapter;
...
import com.dvl.moneymanagement.databinding.ActivityLoanBinding;
...
public class LoanActivity extends BaseActivity {
    ...
    private ActivityLoanBinding binding; // Generated binding class
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.loanRecView.setAdapter(adapter);
        binding.loanRecView.setLayoutManager(new LinearLayoutManager(this));
    ...
    private void initBottomNavView() {
        ...
        binding.bottomNavView.setSelectedItemId(R.id.menu_item_loan);
        binding.bottomNavView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.menu_item_stats) {
                    intent = new Intent(LoanActivity.this, StatsActivity.class);
                } else if (menuItem.getItemId() == R.id.menu_item_transaction) {
                    intent = new Intent(LoanActivity.this, TransactionActivity.class);
                } else if (menuItem.getItemId() == R.id.menu_item_home) {
                    intent = new Intent(LoanActivity.this, MainActivity.class);
                } else if (menuItem.getItemId() == R.id.menu_item_loan) {
                    // Không làm gì cho loan
                } else if (menuItem.getItemId() == R.id.menu_item_investment) {
                    intent = new Intent(LoanActivity.this, InvestmentActivity.class);
                }
